...
1. **Test Reference Script:** Validate the clean reference script works completely before proceeding to variations.
...
**Current task:** 
The PO POST TEST family of tests will test a simple PO process across a series of Items and Locations, total expected test scripts 9 (3 items x 3 locations). I've created the 1st base script with following field variables set:
